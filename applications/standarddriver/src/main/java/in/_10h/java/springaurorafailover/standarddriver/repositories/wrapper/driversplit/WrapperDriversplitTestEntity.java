...
public class WrapperDriversplitTestEntity {
    private Integer id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        WrapperDriversplitTestEntity other = (WrapperDriversplitTestEntity) obj;
        if (id == null) {
            if (other.id != null)
                return false;
    ...
    public String toString() {
        return "WrapperDriversplitTestEntity [id=" + id + ", textVal=" + textVal + ", intVal=" + intVal + "]";
    }
}
