...
public class WrapperSelfsplitTestEntity {
    private Integer id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        WrapperSelfsplitTestEntity other = (WrapperSelfsplitTestEntity) obj;
        if (id == null) {
            if (other.id != null)
                return false;
    ...
    public String toString() {
        return "WrapperSelfsplitTestEntity [id=" + id + ", textVal=" + textVal + ", intVal=" + intVal + "]";
    }
}
